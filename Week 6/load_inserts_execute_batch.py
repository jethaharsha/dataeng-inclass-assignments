...
def load(conn, icmdlist):
	...
	with conn.cursor() as cursor:
            ...
            psycopg2.extras.execute_batch(cursor,f"insert into {TableName} values (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s);",icmdlist)
